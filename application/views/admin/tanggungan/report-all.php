        ...
        <?php
            foreach($cols as $col){
                ...
                if( isset($tanggungan[$col]) && isset($pembayaran[$col]) ){
                    ...
                    if($delta==0){
                        $tagihan="<span class='green'>LUNAS</span>";
                    }elseif($delta>0){
                        $tagihan="<span class='green'>".number_format($delta,0,",",".")."</span>";
                    }else{
                        $tagihan="<span class='red'>".number_format($delta,0,",",".")."</span>";
                    }
                }elseif(isset($tanggungan[$col])){
                    $tagihan="<span class='red'>".number_format(0-$tanggungan[$col],0,",",".")."</span>";
                }elseif(isset($pembayaran[$col])){
                    $tagihan="<span class='green'>".number_format($pembayaran[$col],0,",",".")."</span>";
                }else{
                    $tagihan="";
                }
                echo "<td>".$tagihan."</td>";
